...
// 	handlerChain := chain(g.handlers, handler)
// 	g.router.addRoute(method, fullPath, handlerChain)
// }

// func chain(middleware []func(http.HandlerFunc) http.HandlerFunc, handler http.HandlerFunc) http.HandlerFunc {
...
// func (g *group) Group(prefix string, middleware ...func(http.HandlerFunc) http.HandlerFunc) *group {
...
// func main() {
// 	r := Routerinsiate()
// 	fmt.Println("Runing well")
// 	http.ListenAndServe(":8080", r)
// }
// func Routerinsiate() http.Handler {
// 	r := &router{
...
// 	r.addRoute("POST", "/users", func(w http.ResponseWriter, r *http.Request) {
